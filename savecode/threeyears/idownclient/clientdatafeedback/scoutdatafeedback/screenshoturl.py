"""represents a URL scout screenshot file"""
...
class ScreenshotUrl(OutputData, OutputDataSeg):
    """网页截图文件。此数据按标准键值对数据方式输出"""
    def __init__(self, task: IscoutTask, level: int, parentobj: str,
                 parentobjtype: EObjectType, url: str):
        ...
        OutputData.__init__(self, task.platform, EStandardDataType.IScoutScreenShotUrl)
