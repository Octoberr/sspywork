...
from .fbsearchname_new import FBSearchName_new
from urllib.parse import quote_plus


class FBSearchEmail_new(FBSearchName_new):
    """"""
    def __init__(self, task: IscoutTask):
        super(FBSearchEmail_new, self).__init__(task)

    def _search_email_v1(self, email: str, level: int) -> iter:
        """按邮箱搜索人，返回搜索到的人的基本信息。\n
