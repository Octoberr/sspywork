...
class Afrinic(IPWhoisBase):
    """search ip-whois from arin.net"""

    def __init__(self):
        IPWhoisBase.__init__(self)
        self._api_host: str = "rdap.afrinic.net"

        self._api_ipwhois = "https://rdap.afrinic.net/rdap/ip/"
        # 目前afrinic 没找到查历史的
        self._api_ipwhois_history = "https://rdap.afrinic.net/rdap/ip/"
