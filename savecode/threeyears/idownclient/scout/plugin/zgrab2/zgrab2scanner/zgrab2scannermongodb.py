...
class Zgrab2ScannerMongodb(Zgrab2ScannerBase):
    ...
    def get_banner_mongodb(
        ...
        try:
            ...
            self._parser.parse_banner_mongodb(task, level, portinfo, outfi)

        except Exception:
            self._logger.error("Scan mongodb error: {}".format(
    ...
    def _scan_mongodb(
        ...
        try:
            ...
            outfi = os.path.join(self._tmpdir, "{}_{}.mongodb".format(task.batchid, port))
