...
class Zgrab2ScannerMssql(Zgrab2ScannerBase):
    ...
    def get_banner_mssql(
        ...
        try:
            ...
            self._parser.parse_banner_mssql(task, level, portinfo, outfi)

        except Exception:
            self._logger.error("Scan mssql error: {}".format(
    ...
    def _scan_mssql(
        ...
        try:
            ...
            outfi = os.path.join(self._tmpdir, "{}_{}.mssql".format(task.batchid, port))
