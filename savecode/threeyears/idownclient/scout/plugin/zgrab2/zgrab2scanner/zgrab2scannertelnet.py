...
class Zgrab2ScannerTelnet(Zgrab2ScannerBase):
    ...
    def get_banner_telnet(
        ...
        try:
            ...
            self._parser.parse_banner_telnet(task, level, portinfo, outfi)

        except Exception:
            self._logger.error("Scan telnet error: {}".format(
    ...
    def _scan_telnet(
        ...
        try:
            ...
            outfi = os.path.join(self._tmpdir, "{}_{}.telnet".format(task.batchid, port))
