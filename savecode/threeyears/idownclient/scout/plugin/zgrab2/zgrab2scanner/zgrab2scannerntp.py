...
class Zgrab2ScannerNtp(Zgrab2ScannerBase):
    ...
    def get_banner_ntp(
        ...
        try:
            ...
            self._parser.parse_banner_ntp(task, level, portinfo, outfi)

        except Exception:
            self._logger.error("Scan ntp error: {}".format(
    ...
    def _scan_ntp(
        ...
        try:
            ...
            outfi = os.path.join(self._tmpdir, "{}_{}.ntp".format(task.batchid, port))
