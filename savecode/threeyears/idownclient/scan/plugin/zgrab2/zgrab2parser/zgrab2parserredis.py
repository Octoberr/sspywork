...
class Zgrab2ParserRedis(Zgrab2ParserBase):
    ...
    def parse_banner_redis(self, task: IscanTask, level: int, pinfo_dict, resultfi: str):
        """
        ...
        try:
            ...
            self._logger.error("Parse redis banner error:\ntaskid:{}\nresultfi:{}"
                .format(task.taskid, resultfi))

    def _parse_redis(self, sj: dict, task: IscanTask, level: int, portinfo: PortInfo):
        """
