...
class Zgrab2ParserMySql(Zgrab2ParserBase):
    ...
    def parse_banner(self, task: IscanTask, level: int, pinfo_dict, resultfi: str):
        """
    ...
    def _parse_mysql(self, sj: dict, task: IscanTask, level: int,
                     portinfo: PortInfo):
        """
    ...
    def _parse_tls(self, sj: dict, task: IscanTask, level: int,
                   portinfo: PortInfo):
