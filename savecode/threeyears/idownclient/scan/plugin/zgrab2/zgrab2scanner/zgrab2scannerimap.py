    ...
    def get_banner_imap(
        ...
        *args,
        ...
        try:
            ...
            self._parser.parse_banner_imap(task, level, pinfo_dict, outfi)

        except Exception:
            self._logger.error("Scan imap error: {}".format(traceback.format_exc()))
    ...
    def _scan_imap(
        ...
        *args,
        ...
        try:
            ...
            # outfi = os.path.join(self._tmpdir, "{}_{}.imap".format(task.taskid, port))
            with self._outfile_locker:
                outfi = os.path.join(
                    self._tmpdir, "{}_{}.imap".format(str(uuid.uuid1()), port)
                )
