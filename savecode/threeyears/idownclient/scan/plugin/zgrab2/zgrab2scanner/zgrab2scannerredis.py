    ...
    def get_banner_redis(
        ...
        *args,
        ...
        try:
            ...
            self._parser.parse_banner_redis(task, level, pinfo_dict, outfi)
    ...
    def _scan_redis(
        ...
        *args,
        ...
        try:
            ...
            # outfi = os.path.join(self._tmpdir, "{}_{}.redis".format(task.taskid, port))
            with self._outfile_locker:
                outfi = os.path.join(
                    self._tmpdir, "{}_{}.redis".format(str(uuid.uuid1()), port)
                )
